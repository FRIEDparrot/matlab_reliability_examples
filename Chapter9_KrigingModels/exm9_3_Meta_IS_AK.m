...
for epoch = 1:params.max_epoch2
    ...
    % Pf_arr = [Pf_arr; Pf_calcu(mu_, sigma_, dmodel)];

    fprintf("total sample number: %d, min U_x: %f, Pf: %f\n", size(x_train, 1), U_min, Pf_arr(size(Pf_arr, 1))); 
    if (U_min < 2)
