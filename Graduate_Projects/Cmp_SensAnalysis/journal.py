...
Parameters.ExportAllDesignPointsData(FilePath="E:/workpack/Matlab/MATLAB_reliability_engineering/Graduate_Projects/Meta_IS_AK_SensAnalysis/Stress_data.csv")
Save(Overwrite=True)
